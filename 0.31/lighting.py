...
class Lighting:
    ...
    def computeColorBlinnPhong(self, point, surf, viewdirection, surfOcclusion):
        ...
        for light in self.lights:
            ...
            # check for occlusion
            minocclusion, surfdum = surfOcclusion.intersectRay(point, lightdirection, tmin = shadowrayoffset)
            if (minocclusion > lightdistance):
                ...
                lighttotal += surf.shadingKDiffuse * light[1] * max(np.dot(lightdirection, surfaceNormal), 0)
