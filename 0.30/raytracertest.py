...
#cam.MoveAndRotateCamera(Dz = -97.0)
...
# triangles
triangletest = Triangle(np.array([2,-2,0,1]),np.array([2,2,0,1]), np.array([2,2,2,1]), (255,0,0,0))
...
triangletest2.addSurface(Triangle(np.array([0,0,0,1]),np.array([4,4,0,1]), np.array([4,-4,0,1]), (125,0,125,0)))
triangletest2.addSurface(Triangle(np.array([0,0,0,1]),np.array([4,-4,0,1]), np.array([-4,-4,0,1]), (0,125,0,0)))
triangletest2.addSurface(Triangle(np.array([0,0,0,1]),np.array([-4,-4,0,1]), np.array([-4,4,0,1]), (0,125,125,0)))
