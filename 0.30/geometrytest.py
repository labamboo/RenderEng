...
def test5():
    vec = Coordinate3D.from_coordinates(1.0, 1.0, 1.0, 0.0)
    print("Magnitude of 1,1,1,0")
    print(vec.magnitude())

def test6():
    vec = Coordinate3D.from_coordinates(1.0, 1.0, 1.0, 0.0)
    print("Normalized 1,1,1,0")
    print(vec.normalized().aslist())
    vec2 = Coordinate3D.from_coordinates(1.0, 1.0, 1.0, 1.0)
    print("Normalized 1,1,1,1")
    print(vec2.normalized().aslist())

def test7():
    vec = Coordinate3D.from_coordinates(1.0, 2.0, 1.0, 0.0)
    vec2 = Coordinate3D.from_coordinates(1.0, 1.0, 1.0, 1.0)
    print("Cross 1,1,1,0 and 1,1,1,1")
    print(vec2.cross(vec).aslist())
